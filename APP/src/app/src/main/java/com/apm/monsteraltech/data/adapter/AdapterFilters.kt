...
import com.apm.monsteraltech.ui.activities.main.fragments.products.Filter
...
class AdapterFilters(private val filterList: ArrayList<Filter>) : RecyclerView.Adapter<AdapterFilters.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.fragment_product_filter, parent, false)
