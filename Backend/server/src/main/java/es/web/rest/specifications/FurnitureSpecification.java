...
public class FurnitureSpecification {
  public static Specification<Furniture> searchAll(String search) {
    return new Specification<Furniture>() {
      @Override
      public Predicate toPredicate(
          Root<Furniture> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
