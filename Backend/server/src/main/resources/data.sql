INSERT INTO appuser (id, name, surname, firebaseToken)
...
-- Casa 2
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Casa en la montaña', 'Acogedora casa en la montaña con vista panorámica', 'NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 200000.00);
INSERT INTO t_house (id)
VALUES (LASTVAL());
...
-- Casa 10
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Casa en la ciudad', 'Casa ubicada en el centro de la ciudad con fácil acceso a todos los servicios', 'SECOND_HAND', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 300000.00);
INSERT INTO t_house (id)
VALUES (LASTVAL());
...
-- Mueble 1
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Sofá gris', 'Sofá de 3 plazas en color gris', 'SEMI_NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 350.00);
...
--  Mueble 3
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Silla de oficina', 'Silla ergonómica para oficina', 'NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 150.00);
INSERT INTO t_furniture (id)
VALUES (LASTVAL());
...
--  Mueble 5
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Cama individual', 'Cama individual en color marrón oscuro', 'SEMI_NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 250.00);
INSERT INTO t_furniture (id)
VALUES (LASTVAL());

--  Mueble 6
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Sofá cama', 'Sofá cama en color beige', 'NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 400.00);
INSERT INTO t_furniture (id)
VALUES (LASTVAL());
...
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Sofá de cuero', 'Sofá grande de cuero negro', 'SECOND_HAND', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 250.00);
...
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Microondas Panasonic', 'Microondas de 1.2 pies cúbicos', 'NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 100.00);
...
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Secadora Whirlpool', 'Secadora eléctrica', 'NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 400.00);
...
INSERT INTO t_product (name, description, state, owner, price)
VALUES ('Lavadora Samsung', 'Lavadora automática de carga frontal', 'SEMI_NEW', 'pfpY9jg25hfdKPaDMyKqg5GIkPV2', 800.00);
