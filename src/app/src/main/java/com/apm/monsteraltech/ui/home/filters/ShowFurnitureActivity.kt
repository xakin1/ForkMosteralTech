...
class ShowFurnitureActivity : ActionBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_show_furniture_home)
        setToolBar()
        applyFilters()
    ...
    private fun performSearch(query: String?) {
        ...
        if (filteredlist.isEmpty()) {
            Toast.makeText(this@ShowFurnitureActivity, "No Data Found..", Toast.LENGTH_SHORT).show()
        } else {
